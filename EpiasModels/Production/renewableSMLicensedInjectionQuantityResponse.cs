...
namespace EpiasModels.Production
{
    ...
    /// </summary>
    public class renewableSMLicensedInjectionQuantityResponse
    {
        ...
        public class Body
        {
            ...
            public Renewablesmproductionlist[] renewableSMProductionList { get; set; }
        }
        ...
        {
            string strReturn = @"https://seffaflik.epias.com.tr/transparency/service/production/renewable-sm-licensed-injection-quantity?startDate=" + startDate.ToString("yyyy-MM-dd") + "&endDate=" + endDate.ToString("yyyy-MM-dd");
