...
namespace EpiasModels.Yekg
{
    ...
    /// </summary>
    public class redemptionAmountResponse
    {
        ...
        {
            return @"https://seffaflik.epias.com.tr/transparency/service/yekg/redemption-amount-list?startDate=" + startDate.ToString("yyyy-MM-dd") + "&endDate=" + endDate.ToString("yyyy-MM-dd");
        }
