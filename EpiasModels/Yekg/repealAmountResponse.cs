...
namespace EpiasModels.Yekg
{
    ...
    /// 
    /// </summary>
    public class repealAmountResponse
    {
        ...
        {
            return @"https://seffaflik.epias.com.tr/transparency/service/yekg/repeal-amount-list?startDate=" + startDate.ToString("yyyy-MM-dd") + "&endDate=" + endDate.ToString("yyyy-MM-dd");
        }
