...
namespace EpiasModels.Market
{
    ...
    /// </summary>
    public class damIncomeResponse
    {
        ...
        {
            string strReturn = @"https://seffaflik.epias.com.tr/transparency/service/market/day-ahead-market-income-summary?startDate=" + startDate.ToString("yyyy-MM-dd") + "&endDate=" + endDate.ToString("yyyy-MM-dd");
            if (period != null)
            {
