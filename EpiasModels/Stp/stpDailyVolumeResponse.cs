...
namespace EpiasModels.Stp
{
    ...
    /// </summary>
    public class stpDailyVolumeResponse
    {
        ...
        {
            return @"https://seffaflik.epias.com.tr/transparency/service/stp/volume/stp-daily-volume?startDate=" + startDate.ToString("yyyy-MM-dd") + "&endDate=" + endDate.ToString("yyyy-MM-dd");
        }
